...
function Services() {
  return (
    <div className="my-5 md:my-12">
      ...
      <h3 className="text-xl font-medium my-4">Interpretation</h3>
      <p className="my-4">
      ...
      <h3 className="text-xl font-medium my-4">Definitions</h3>
      ...
      <p className="my-4">
        Welcome to Recifood! By using our services, you agree to comply with and
        be bound by the following terms and conditions. Please read these terms
        carefully before accessing or using our application.
      </p>
      <ul className="list-decimal px-3 ">
        ...
        <li className="my-4">
          ...
          <p>
            ...
            software, are the property of Recifood or its licensors and are
        ...
        <li className="my-4">
          ...
          <p>
            ...
            accuracy, completeness, or timeliness of the content on our app.
          </p>
        </li>
        <li className="my-4">
          ...
          <p>
            ...
            app. Your continued use of the app after any changes signifies your
      ...
      <p className="my-4">
        ...
        us at&nbsp;
        <Link href="mailto:ashishjaiswar771@gmail.com" className="underline">
